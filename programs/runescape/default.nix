# ADAPTED FROM https://gitlab.com/kira-bruneau/nur-packages/-/blob/main/pkgs/games/runescape-launcher/default.nix

{ pkgs ? import <nixpkgs> {}, lib ? pkgs.lib, stdenv ? pkgs.stdenv, fetchurl ? pkgs.fetchurl, dpkg ? pkgs.dpkg }:
